...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="bg-secondary mb-5 row">
            <div class="col-1"></div>
            <div class="col-1">
                <h1 class="text-white titulo mt-2 ms-3">Equipes</h1>
            </div>
            <div class="col-8"></div>
            <div class="col-1 mt-2">
                <a class="navbar-brand" href="/cadastroEquipes">
        ...
        @foreach($equipes as $equipe)
            <div class="row mb-2 mt-2">
                <div class="col-1"></div>
                <div class="col-1">
                    <img src="{{ asset('images/People.png') }}"  alt="Bootstrap" width="50" height="50">
                </div>
                <div class="col-3 row">
                    <div class="col-5">
                        <h2 class="ms-4"> Equipe:</h2>
                    </div>
                    <div class="col-7">
                        <h2 class="text-danger">{{$equipe->nome}}</h2>
                    </div>

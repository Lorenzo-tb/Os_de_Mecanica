...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="bg-secondary mb-5 row">
            <div class="col-1"></div>
            <div class="col-1">
                <h1 class="text-white titulo mt-2 ms-3">Funcionários</h1>
            </div>
            <div class="col-8"></div>
            <div class="col-1 mt-2">
                <a class="navbar-brand" href="/cadastroFuncionarios">
        ...
        @foreach($funcionarios as $funcionario)
            <div class="row mb-2 mt-2">
                ...
                <div class="col-3"><h2 class="text-danger">{{$funcionario->nome}}</h2></div>
                <div class="col-2">
                    <div>
                        <h3> Equipe: {{$funcionario->equipe->nome}}</h3>
                    </div>
                </div>
                <div class="col-2"></div>
                <div class="col-1">
                <a href="{{ route('funcionarios.edit', ['id' => $funcionario->id]) }}" class="bg-transparent border-0">
